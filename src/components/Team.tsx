...
export function Team() {
  return (
    <section className="grid grid-rows-2 grid-cols-1 sm:grid-cols-2 sm:grid-rows-1 ml-16 max-w-[100vw]">
      <div>
        ...
        <ul className="grid max-w-md gap-3 text-light font-Poppins">
