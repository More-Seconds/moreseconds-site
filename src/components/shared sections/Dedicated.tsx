...
export function Dedicated(props: Props) {
  return (
    ...
    >
      <Heading
        level="2"
        className="max-w-[15ch] sm:max-w-none mx-auto text-3xl mb-10 sm:text-3xl xl:text-[46px] tracking-tighter"
      >
        Your Dedicated Digital Team
      </Heading>
      <BodyText className="text-xl sm:text-lg sm:mx-10 xl:mx-auto xl:max-w-3xl">
      ...
      <BallOrange className="absolute hidden sm:block sm:top-1/2 sm:-left-4 sm:scale-50 xl:left-40" />
      <Star className="absolute hidden sm:block sm:bottom-0 sm:left-10" />
      <BallOrange className="absolute hidden sm:block sm:-top-10 sm:right-0 xl:right-24" />
