...
export function Team() {
  return (
    <SideBySide svg={TeamImage}>
      <SmallTitle>Our values</SmallTitle>
      <Heading level="2" className="max-w-lg mb-10">
        A Reliable Web Development Team You Can Trust
      </Heading>
      <ul className="relative z-20 grid max-w-md gap-3 text-light font-Poppins">
        <Accordian title="Customer Service First" image={Headset}>
          ...
          understand and address the unique challenges that your business faces.
        </Accordian>
        <Accordian title="Fast" image={Fast}>
          ...
          unnecessarily bill more hours. More Seconds has the fastest turnaround
          time in the industry.
        </Accordian>
        <Accordian title="Responsive" image={Envelope}>
          We’ll never leave you hanging. We know how frustrating a lack of
          communication can be so rest assured, you will never have to follow up
          with our team. All questions, concerns, and updates are addressed
          on-demand.
        </Accordian>
