  ...
  return (
    <section className="relative mb-0 sm:mb-0 sm:pt-20 md:py-[7rem]">
      ...
      <div className="flex flex-col md:mx-4 md:mr-8">
        ...
        <div className="z-20 sm:px-[25px] sm:mt-[5rem] sm:text-center md:text-left md:pl-0 md:pr-[64px] lg:flex lg:flex-col lg:items-end">
          <Heading
            level="2"
            className="text-3xl sm:max-w-2xl sm:my-0 sm:text-center md:mt-20 md:mb-10 md:text-left md:text-[1.75rem] lg:flex lg:flex-col åßlg:text-[2.5rem] lg:leading-[1] lg:justify-end xl:max-w-2xl xl:text-5xl xl:mt-12"
          >
            We're trusted service partners for the most influential industry
            leaders.
          </Heading>
          <ul className="flex w-full gap-4 justify-end">
