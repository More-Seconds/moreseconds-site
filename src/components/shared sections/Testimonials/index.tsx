  ...
  return (
    <section className="relative flex flex-col py-16 mx-4 lg:py-32 sm:mx-32 lg:mx-auto lg:max-w-4xl">
      ...
      <div className="flex gap-4 mx-auto mb-5 sm:gap-24">
        ...
        <div className="absolute flex items-center justify-center w-8 h-8 border rounded-full right-10 sm:-left-20 sm:top-1/2 hover:border-accent lg:w-12 lg:h-12">
          <CarouselArrow
            className="rotate-180 fill-mid hover:fill-accent w-full h-full scale-125"
            onClick={decrementActive}
          />
        </div>
        <div className="absolute right-0 flex items-center justify-center w-8 h-8 border rounded-full sm:-right-20 sm:top-1/2 hover:border-accent lg:w-12 lg:h-12">
          <CarouselArrow
