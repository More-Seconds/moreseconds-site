    ...
    <Layout footerVariant="simplified">
      <section className="flex flex-col items-center justify-center w-min">
        <HeroCentered className="">
          ...
          <BodyText className="px-5 mx-auto text-center sm:max-w-4xl sm:px-10">
            From on-demand updates to urgent after-hours fixes, More Seconds premium web support offers the easiest way to make rapid changes to your website. We provide a completely hands-off website maintenance and updates service with a dedicated Project Manager to address all of your questions, comments, and concerns regarding your website.
          </BodyText>
      ...
      >
        ...
        <BodyText className="max-w-xs sm:max-w-none">
          We offer on-call and on-demand web support that seamlessly integrates into your project management workflow. Our expert #dev-ops team is always available to handle any issue that arises.
        </BodyText>
      </SideBySide>
      ...
      <section className="flex flex-wrap items-center justify-center mt-20 mb-60">
        <Card>
          ...
          <BodyText className="pt-5">
            We are always on call to handle all common issues that may pop up on your website.
          </BodyText>
        </Card>
        ...
        <Card>
          ...
          <BodyText className="pt-5">
            We are available to make rapid text, image, and video changes to any section of your website or web page that may need updating.
          </BodyText>
        </Card>
        ...
        <Card>
          ...
          <BodyText className="pt-5">
            We can help keep your website's plugins, theme, core, and other important features updated and running smoothly.
          </BodyText>
        </Card>
        ...
        <Card>
          ...
          <BodyText className="pt-5">
            We're able to sync your website to third party apps like Mailchimp as well as common platforms that may require some connection to your site.
          </BodyText>
        </Card>
      </section>
