      ...
      <section className="flex flex-col items-center justify-center md:pb-[18rem] md:h-screen max-w-full mx-[1rem]">
        <HeroCentered className="md:py-0">
          ...
          <h1 className="text-white mb-2 text-3xl md:text-5xl font-semibold max-w-4xl mx-auto text-center">
            ...
            <span className="text-accent">More Seconds</span>
          </h1>
      ...
      <section className="how--it--works h-full flex flex-col items-center bg-black">
        ...
        <div className="flex flex-col items-center justify-center md:mb-10">
          <div className="flex flex-col md:flex-row items-center px-6 md:ml-[17rem] lg:ml-[22rem] md:max-w-xl my-[4rem] md:my-[6rem] md:px-10 lg:px-2">
            <TeamImage className="hidden md:block absolute right-[37%] md:right-[20%] scale-x-[-1] h-[30%] md:h-[20%] lg:h-[50%] xl:top-[307%] xl:left-[-14%] 2xl:top-[295%] 2xl:left-[-6%] 2xl:h-[60%]" />
        ...
        <div className="flex flex-col items-center justify-center mb-[6rem] md:mb-[8rem]">
          <div className="flex md:w-full md:ml-[12rem] lg:ml-[16rem] my-20">
            <div className="flex flex-col md:flex-row items-center md:mb-[6rem] px-6 md:px-0">
              ...
              <p className="absolute text-black text-3xl lg:text-6xl mt-3 md:mt-0 md:ml-[1.5rem] lg:ml-7 font-semibold">
                2
              </p>
            ...
            <MusicLady className="hidden md:block absolute right-[-8%] md:right-[-18%] top-[336%] scale-[30%] md:scale-[35%] xl:right-[5%] lg:scale-[55%] 2xl:scale-[60%] md:top-[288%] xl:top-[427%] 2xl:top-[415%] 2xl:right-[14rem] z-10" />
            <SaturnPurple className="hidden md:block h-[160px] w-[160px] absolute right-[8%] md:right-[4%] lg:right-[8%] 2xl:right-[14rem] mt-[4rem] md:mt-[7rem] lg:mt-[4rem] rotate-14 md:h-[180px] md:w-[180px] lg:h-[300px] lg:w-[300px] 2xl:h-[250px] 2xl:w-[320px] 2xl:top-[435%] scale-x-[-1]" />
          </div>
          <div className="h-[70%] w-[70%] z-[999]">
            <img src={Client2} alt="" />
          </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex px-6 md:px-0 justify-center md:justify-end w-full md:mr-[6rem] lg:mr-[20rem] mb-[6rem] md:mb-[10rem] lg:mb-[12rem]">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <FormCharacter className="hidden md:block absolute h-[260px] w-[260px] left-[5%] xl:left-[10%] xl:top-[570%] 2xl:h-[380px] 2xl:w-[380px] xl:h-[330px] xl:w-[330px] md:h-[200px] md:w-[200px] 2xl:left-[15%] 2xl:top-[545%] scale-x-[-1]" />
            </div>
          </div>
          <div className="h-[70%] w-[70%] z-[999]">
            <img src={Client3} alt="" />
          ...
          <div className="flex justify-start md:ml-[10rem] lg:ml-[26rem] w-full mt-[5rem] mb-[6rem]">
            <div className="flex flex-col md:flex-row items-center px-6 md:px-0">
              ...
              <div className="ml-6 flex flex-col items-center md:items-start">
                ...
                <div>
                  <Rocket className="hidden md:block absolute -rotate-45 scale-[35%] right-[4%] md:right-[3%] xl:scale-[60%] 2xl:scale-[65%] xl:right-[10%] 2xl:right-[17%] 2xl:top-[660%] top-[546%] md:top-[428%] lg:top-[700%]" />
                  <Planet className="hidden md:block absolute xl:right-[10%] 2xl:right-[17%] 2xl:top-[683%] scale-[125%] md:top-[442%] lg:top-[726%] right-[5%] xl:scale-[200%] 2xl:scale-[250%]" />
                </div>
