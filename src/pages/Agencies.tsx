      ...
      <section className="how--it--works h-full flex flex-col items-center  bg-black">
        ...
        <div className="flex flex-col items-center mb-10">
          <div className="flex ml-[22rem] max-w-xl my-[6rem]">
            <TeamImage className="absolute scale-x-[-1] sm:h-[45%] lg:top-[325%] lg:left-[-16%] 2xl:top-[185rem] 2xl:left-[-7rem] 2xl:h-[60%]" />
        ...
        <div className="flex flex-col items-center mb-[8rem]">
          <div className="flex w-full ml-[24rem] my-20">
            ...
            <MusicLady className="absolute xl:right-[0%] lg:scale-[50%] 2xl:scale-[60%] xl:top-[430%] 2xl:top-[258rem] 2xl:right-[14rem] z-10" />
            <SaturnPurple className="absolute lg:right-[8%] 2xl:right-[14rem] lg:mt-10 rotate-14 lg:h-[250px] lg:w-[250px] 2xl:h-[250px] 2xl:w-[320px] 2xl:-bottom-[232rem] scale-x-[-1]" />
          </div>
          <div className="h-[70%] w-[70%] z-[999]">
            <img src={Client2} alt="" />
          </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex justify-end w-full mr-[20rem] mb-[10rem]">
            <div className="flex items-center">
              ...
              <FormCharacter className="absolute xl:left-[16%] xl:top-[580%] 2xl:h-[380px] 2xl:w-[380px] xl:h-[320px] xl:w-[320px] 2xl:left-[15%] 2xl:top-[570%] scale-x-[-1]" />
            </div>
          </div>
          <div className="h-[70%] w-[70%] z-[999]">
            <img src={Client3} alt="" />
          ...
          <div className="flex justify-start ml-[26rem] w-full mt-[10rem] mb-[8rem]">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                ...
                <div>
                  <Rocket className="absolute -rotate-45 xl:scale-[50%] 2xl:scale-[65%] xl:right-[7%] 2xl:right-[17%] 2xl:-mt-[10rem] xl:-mt-[12rem]" />
                  <Planet className="absolute xl:right-[7%] 2xl:right-[17%] 2xl:top-[708%] xl:scale-[240%] 2xl:scale-[270%]" />
                </div>
