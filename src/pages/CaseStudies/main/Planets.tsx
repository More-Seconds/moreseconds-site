  ...
  return (
    <section className="relative">
      <div className="relative w-32 h-32 mx-auto sm:w-48 sm:h-48 lg:h-64 lg:w-64">
        ...
        <BodyText className="absolute w-20 text-sm leading-4 sm:w-auto text-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 lg:text-[24px] lg:leading-[30px]">
          Marketing Agencies
        </BodyText>
      </div>
