...
export function Stats() {
  return (
    <section className="relative mx-4 sm:mx-16 lg:mx-32 2xl:mx-auto 2xl:max-w-[1600px] 2xl:px-32">
      <div className="relative z-0 flex items-end justify-end h-0 -right-4 sm:-right-16 lg:-right-32">
        <Cloud />
