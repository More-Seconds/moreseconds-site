  ...
  return (
    <Layout footerVariant="delivers">
      ...
      >
        ...
        <Heading level="2">
          Looking to uncover opportunities to improve your development workflow?
          We identify solutions that drive ROI.
        </Heading>
        <BodyText className="max-w-xs sm:max-w-none">
          We are experts at analyzing multiple data points related to user
          satisfaction and goal conversions. From there, we produce detailed and
          executable blueprints designed to make implementing our solutions a
          breeze. Our aim is to deepen the knowledge and digital resource base
          that will continue to power your business long-term.
        </BodyText>
      </SideBySide>
