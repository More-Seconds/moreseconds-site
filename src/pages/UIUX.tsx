    ...
    <Layout>
      <section className="flex flex-col items-center justify-center w-min">
        <HeroCentered background = {Smoke} className="">
          ...
          <BodyText className="px-5 mx-auto text-center sm:max-w-4xl sm:px-10">Get a beautifully designed website that doesn’t break the bank. We provide pixel perfect design options to ensure each web project we deliver is an aesthetic masterpiece. Work with our design team to create a website that wows and start maximizing your conversion rate today.</BodyText>
          <Button href="" className="block max-w-xs mx-auto mt-6 text-center">Get More Seconds</Button>
        </HeroCentered>
      </section>
      ...
      <SideBySide svg={Planet} reverse className="flex items-center justify-center pb-20 pl-6">
      ...
      <section className="flex flex-wrap items-center justify-center mt-20 mb-60">
       <Card>
        ...
        <BodyText className="pt-5">We provide full-service digital design services to create state-of-the-art web pages and full website design solutions.</BodyText>
       </Card>

       <Card>
        <Heading level="2">Landing Page Design & Revamp</Heading>
        <BodyText className="pt-5">Whether you are starting from scratch or simply interested in updating your current page, we’re excited to bring your ideas to life.</BodyText>
       </Card>

       <Card>
        <Heading level="2">Rapid Prototyping & Design Discovery</Heading>
        <BodyText className="pt-5">You’ll see exactly how your custom designs are progressing each step of the way with mockups in Figma and your input is always welcome.</BodyText>
       </Card>

       <Card>
        <Heading level="2">Web Branding & Visual Identity Design</Heading>
        <BodyText className="pt-5">We’ll create a consistent look and feel for your business across the digital landscape with the development of a brand kit guideline.</BodyText>
       </Card>
      </section>
