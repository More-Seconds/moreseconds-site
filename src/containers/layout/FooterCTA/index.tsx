...
export function FooterCTA(props: Props) {
  return (
    <div className="w-screen lg:px-16" id="contact">
      <section className="relative shrink-0 grid grid-flow-row gap-10 pt-4 pb-8 rounded-lg sm:pt-20 bg-light sm:grid-cols-1 sm:grid-rows-1 sm:grid-cols-1 sm:px-[15px] sm:pt-[7rem] sm:bg-[#ebebed] sm:mr-[15px] sm:ml-0 md:grid-cols-2 md:pt-[8.5rem] md:px-[64px] md:max-w-[calc(100%_-_10%)] md:mx-auto lg:max-w-[calc(100%)] xl:pt-40 xl:pb-32 xl:mx-auto xl:max-w-[1400px] xl:px-[45px] xl:place-items-stretch xl:justify-items-center after:content-[''] after:shadow-inner after:shadow-[10px_10px_0px_#6e2ac3] after:rounded-lg after:absolute after:left-0 after:top-[0px] after:w-full after:h-full">
