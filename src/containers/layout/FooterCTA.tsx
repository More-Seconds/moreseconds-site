...
export function FooterCTA() {
  ...
  return (
    <section className="relative grid grid-rows-2 gap-10 px-8 pt-20 pb-8 rounded-lg bg-light place-items-center lg:place-items-stretch lg:justify-items-center sm:grid-cols-2 sm:grid-rows-1 sm:mx-8 lg:px-20 lg:pt-40 lg:pb-32 lg:mx-16">
